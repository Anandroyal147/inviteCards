        ...
        <>
                    ...
                    <div id="invoice" class="effect2">
                        ...
                        <div id="invoice-top">
                            ...
                            <div class="title">
                                ...
                                <p>Invoice Date: <span id="invoice_date">{date}</span><br />
                            ...
                            <div class="clearfix">
                                <div class="col-left">
                                    ...
                                    <div class="clientinfo">
                                        <p>State: <span id="invoice_date">Tamil Nadu</span><br /></p>
            ...
            <div class="cta-group text-center">
                <Pdf targetRef={ref} filename="test.pdf" >
                    {({ toPdf }) => (
                        <button class="btn-primary" onClick={toPdf}>Approve</button>
                    )}
                </Pdf>
                <Link to={'/products'}>  <button href="javascript:void(0);" class="btn-default">Reject</button></Link>
            </div>
